...
2. Config (Pour deferencier les different site (physical location) sur logique) [Site ete service active directory]
3. Schema ( structure,  nad object attributes)
4. Application (les applications en contact avec AD)
